                                        ...
                                        while($prod=mysql_fetch_array($productos)){
                                            echo '
                                                <div id="update-product">
                                                  <form method="post" action="/updateProduct.php" id="res-update-product-'.$upr.'">
                                                    <tr>
                                                        <td>
                ...
                <div role="tabpanel" class="tab-pane fade" id="Proveedores">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>NIT</label>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="del-prove">
                            ...
                            <form action="/delprove.php" method="post" role="form">
                                <div class="form-group">
                                              ...
                                              while($prov=mysql_fetch_array($proveedores)){
                                                  echo '
                                                      <div id="update-proveedor">
                                                        <form method="post" action="/updateProveedor.php" id="res-update-prove-'.$up.'">
                                                          <tr>
                                                              <td>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="add-categori">
                                ...
                                <form action="/regcategori.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Código</label>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="add-admin">
                                ...
                                <form action="/regAdmin.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Nombre</label>
                                            ...
                                            while($peU=mysql_fetch_array($pedidoU)){
                                                echo '
                                                    <div id="update-pedido">
                                                      <form method="post" action="/updatePedido.php" id="res-update-pedido-'.$upp.'">
                                                        <tr>
